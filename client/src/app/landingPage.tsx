			...
			<div data-testid='landingpage' className='flex top-16 p-8 relative justify-start items-center flex-col text-center '>
				...
				<p className='max-w-[700px] '>
					...
					<span>
						...
						<strong>User List: </strong>Displays all users and their album counts.
						<strong>User Detail:</strong> Shows user information and their albums.
						<strong>Album Management: </strong>Album Detail: Lists details of selected albums and photos.
						<strong>Photo Management:</strong> Photo Detail: Allows editing of photo titles with backend updates.
					</span>
				</p>
